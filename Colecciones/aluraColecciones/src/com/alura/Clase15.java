...
public class Clase15 {
   ...
   /*     curso1.addClase(alumno1);
        curso1.addClase(alumno2);
        curso1.addClase(alumno3);
        curso1.addClase(alumno4);
        curso1.addClase(alumno5);
        curso1.addClase(alumno6);
        curso1.addClase(alumno7);

        Alumno alumnoNuevo = new Alumno("Luis Miguel", "001");

        System.out.println(alumno1.equals(alumnoNuevo));
        System.out.println(curso1.getRequisitos(alumnoNuevo));*/
    }
}